...
class OrderStatusHistoryPolicy
{
    ...
    public function view(User $user, OrderStatusHistory $orderstatushistory)
    {
    ...
    public function update(User $user, OrderStatusHistory $orderstatushistory)
    {
        return $this->isAdmin($user);
    }

    public function delete(User $user, OrderStatusHistory $orderstatushistory)
    {
        return $this->update($user, $orderstatushistory);
    }
}
