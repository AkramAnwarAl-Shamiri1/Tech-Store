...
class OrderCouponPolicy
{
    ...
    public function view(User $user, OrderCoupon $ordercoupon)
    {
    ...
    public function update(User $user, OrderCoupon $ordercoupon)
    {
        return $this->isAdmin($user);
    }

    public function delete(User $user, OrderCoupon $ordercoupon)
    {
        return $this->update($user, $ordercoupon);
    }
}
